(function($) {
  ...
  $(document).ready(function() {
    ...
    // $('.views-field-field-call-to-action .field-content.btn-style').hover(function() {
    //   $(this).parent().find('#da-thumbs > li div').css('display', 'block').css('left', '0px').css('top', '0px');
    // });

    // $('#da-thumbs > li').hover(function() {
    //   $(this).parents('.views-field.views-field-nothing').prev().find('.btn-style > a').css({"background-color": "#78a952", "color": "#fff"});
    // },
    //  function() {
    //   $(this).parents('.views-field.views-field-nothing').prev().find('.btn-style > a').css({"background-color": "#fff", "color": "#78a952"});
    //   }
    // );
   
   // $('#da-thumbs > li').hover(function(e) {
   //    $(this).parents('.views-field.views-field-nothing').prev().addClass('activeHover');

   //  // if($('.view.view-modules.view-id-modules.view-display-id-block .views-field.views-field-field-call-to-action').hasClass('activeHover')){
   //  //      $(this).mouseup(function(){
   //  //        $('.view.view-modules.view-id-modules.view-display-id-block .views-field.views-field-field-call-to-action.activeHover .btn-style ').addClass('btnHover');
   //  //    console.log(test);
   //  //      });
   ...
   //  },
   //   function() {
   //    $(this).parents('.views-field.views-field-nothing').prev().removeClass('activeHover');
   //    }
   //  );
